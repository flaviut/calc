  ...
  return (
    <Layout title="Buck Converter Power Stage Calculator">
      <CalcRow>
        ...
        <p>
          {" "}
          This calculator provides assistance when designing a buck regulator.
          The equations here are derived from&nbsp;
          <a href="https://www.ti.com/lit/an/slva477b/slva477b.pdf">
            TI's "Basic Calculation of a Buck Converter's Power Stage", SLVA477B
          </a>
          . You'll want to be following along in that document as you fill this
          worksheet out.
        </p>
        <CalculatorHelpBase />
      </CalcRow>
      ...
      <CalcRow>
        ...
        <p>
          The inductor ripple current is the difference between the maximum and
          the minimum current flowing through the output inductor <i>L</i>. This
          value is used later on to calculate the peak current flowing through{" "}
          <i>Q</i>.
        </p>
        <CalculatorInputField
          // prettier-ignore
      ...
      <CalcRow>
        ...
        <p>
          Schottky doides are recommended in order to reduce losses. The forward
          current rating should be the same as the expected output current. Peak
          current ratings for Schottky diodes is usually much higher than the
          average rating, so there is no need to worry about the peak current
          calculated above.
        </p>
        <CalculatorInputField
          // prettier-ignore
